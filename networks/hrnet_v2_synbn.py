...
class HighResolutionNet(nn.Module):
    def __init__(self, cfg, num_classes, **kwargs):
        ...
        self.last_layer = nn.Conv2d(128, self.num_classes, kernel_size=1, stride=1, padding=0, bias=True)
    ...
    def forward(self, x):
        ...
        # print (y_list[0].size(),y_list[1].size(),y_list[2].size(),y_list[3].size())
        y_out =[]
        for i in range(4):
