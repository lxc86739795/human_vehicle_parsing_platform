    ...
    if args.start_epoch >0:
        ...
        for state_name in state_dict_pretrain:
            ...
            if state_name in new_params:
                ...
                new_params[state_name.replace('norm.','norm_')] = state_dict_pretrain[state_name]
            elif 'relu.' in state_name:
                new_params[state_name.replace('relu.','relu_')] = state_dict_pretrain[state_name]
            elif 'conv.' in state_name:
                new_params[state_name.replace('conv.','conv_')] = state_dict_pretrain[state_name]
            else:
