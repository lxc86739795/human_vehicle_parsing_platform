...
# GPU_IDS='0,1,2,3'
# INPUT_SIZE='384,384'
# SNAPSHOT_FROM='/home/liuxinchen3/notespace/project/parsing_platform/models/hrnet_vp_fine/hrnet_epoch_50.pth'
...
nohup python -u evaluate.py --data-dir ${CS_PATH} \
       ...
       --save-dir ${OUTPUTS} > ${OUTPUTS}/log_eval_hrnet_vp_${DATASET}.txt 2>&1 &