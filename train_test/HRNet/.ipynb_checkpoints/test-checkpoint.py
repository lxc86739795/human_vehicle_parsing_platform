...
def main():
    ...
    if 'vehicle_parsing_dataset' in args.data_dir:
        parsing_dataset = VPDataSet(args.data_dir, args.dataset, crop_size=input_size, transform=transform, list_path=args.list_path)
    ...
    if 'other' in args.dataset:
        write_results(parsing_preds, scales, centers, args.data_dir, args.dataset, args.save_dir, input_size=input_size, list_path=args.list_path)
    else:
