...
INPUT_SIZE='384,384'
SNAPSHOT_DIR='/export2/home/lxc/project/parsing_platform/models/deeplabv3_vp_coarse'
...
# RESTORE_FROM='/export2/home/lxc/project/parsing_platform/LIP_models_trained/resnet101-imagenet.pth'
# INPUT_SIZE='384,384'
# SNAPSHOT_DIR='/export2/home/lxc/project/parsing_platform/models/deeplabv3_vp_fine'
# DATASET='fine_train'
# NUM_CLASSES=59
# EPOCHS=150
# START=0
...
nohup python -u train.py --data-dir ${CS_PATH} \
       ...
       --start-epoch ${START} \
       --list_path ${LIST_PATH} \
       --save_step ${SAVE_STEP} > log_train_deeplabv3_VP_${DATASET}.txt 2>&1 &
