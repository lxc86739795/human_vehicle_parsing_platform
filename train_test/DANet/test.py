...
from dataset.datasets_test import LIPDataSet
import os
import torch.nn.functional as F
import torchvision.transforms as transforms
from utils.miou import compute_mean_ioU,test_results
...
def main():
    ...
    lip_dataset = LIPDataSet(args.data_dir, 'val', crop_size=input_size, transform=transform,list_path=args.list_path)
    ...
    test_results(parsing_preds, scales, centers, args.data_dir,args.list_path, args.save_dir, input_size=input_size)
