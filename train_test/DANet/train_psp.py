...
from utils.danet_customize import SegmentationMultiLosses
...
def main():
    ...
    deeplab = DANet(nclass=args.num_classes, backbone='resnet101' ,dilated=True, multi_grid=args.multi_grid,multi_dilation=args.multi_dilation)
    ...
    if args.start_epoch >0:
        ...
        for state_name in state_dict_pretrain:
            state_name_new='pretrained.'+state_name#[6:]
    ...
    criterion = SegmentationMultiLosses(nclass=args.num_classes,ignore_index=255)
