...
def main():
    ...
    lip_dataset = LIPDataSet(args.data_dir, 'test', crop_size=input_size, transform=transform)
    ...
    write_results(parsing_preds, scales, centers, args.data_dir, 'test', args.save_dir, input_size=input_size)
